...
INSERT INTO `evento` VALUES (1,'Festival de Verão','evento de verao','2024-12-15 00:00:00','Praia Central',1),(2,'Congresso de Tecnologia','Evento de tecnologia','2024-11-20 00:00:00','Centro de convencoes',2),(3,'Show Internacional','Evento internacional','2024-10-30 00:00:00','Arena Principal',3),(2001,'Evento Antigo','teste teste','2023-05-28 14:32:50','Franca-SP',1),(3001,'Show de Teste','teste teste','2025-05-31 15:22:28','Franca-sp',1);
...
INSERT INTO `ingresso` VALUES (1,500.00,'vip',1),(2,150.00,'pista',1),(3,200.00,'pista',2),(4,600.00,'vip',3),(5,250.00,'pista',3),(4001,110.00,'pista',3001);
...
/*!50106 CREATE*/ /*!50117 DEFINER=`alunods`@`%`*/ /*!50106 EVENT `arquivar_compras_antigas` ON SCHEDULE EVERY 1 DAY STARTS '2025-05-29 14:22:09' ON COMPLETION PRESERVE ENABLE DO insert into historico_compra(id_compra, data_compra, id_usuario)
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`alunods`@`%`*/ /*!50106 EVENT `reajuste_precos_eventos_proximos` ON SCHEDULE EVERY 1 DAY STARTS '2025-05-28 15:24:47' ON COMPLETION PRESERVE ENABLE DO update ingresso set preco = preco * 1.10
...
-- Dump completed on 2025-05-28 15:53:05
